...
public abstract class Personaje extends MadreDeTodo implements Peleable, Serializable {
	...
	/**
	 * Metodo void que sobreescribe el atributo clan. Añade al personaje llamador al
	 * clan enviado como parámetro.
	 * 
	 * @param clan
	 *            Nueva del personaje.
	 */
	 ...
	 * y que ataque poseaa. El daño critico se obtiene de la clase casta. El entero
	 * surge de la multiplicacion del ataque del personaje y el daño critico de la
	 * casta que pertenece.
	 * 
	 ...
	 * clase MyRandom es mayor a la probabilidad de evitar daño, La cual depende de
	 * la casta del Personaje, entonces no podrá evitarse el ataque, se descontará
	 * el valor del argumento daño al atributo salud. Si el valor del atributo salud
	 * es menor al valor del argumento daño, se procederá a igualar el atributo
	 * salud a 0 y retornar el daño realziado (que será igual a la salud antes de
	 * que esté en 0)
	 * 
	 * @param danio
	 ...
	 * daño total recibido se le resta la defensa del personaje. Si este daño es
	 * menor o igual a la salud del personaje se le quita daño puntos de salud. Si
	 * el daño es mayor a la salud se establece la salud del personaje en 0.
	 * 
	 * @param danio
	...
	/**
	 * Metodo que retorna los puntos de energia quitados al personaje. Al daño total
	 * ejercido al personaje se le resta la defensa del mismo. Si este daño es menor
	 * o igual a la energia del personaje se le resta al mismo, sino se establece
	 * energia como 0.
	 * 
	 * @param danio
	 *            Daño causado al personaje
	...
	/**
	 * Metodo que retorna un boolean si pudo añadir un nuevo aliado a la alianza en
	...
	public int getTopeFuerza() {
		return FUERZAMAXIMA;
	}

	public int getTopeDestreza() {
		return DEFENSAMAXIMA;
	}

	public int getTopeInteligencia() {
